...
<html>
    <body class="bodyclass" onload="startTime()">
        ...
        <div class="mainsite">
            ...
            <% if (staffsearchlist == null && session.getAttribute("regsearch") != null) { %>
                <p>Your search produced no results - <a href="staffCatalog.jsp">Click here view all items</a></p>
            <%
                }
            %>
            <table class="table">
                <tr><td></td><td>Item Name</td><td>Price</td><td>Stock</td><td>Status</td><td>Category</td><td>Supplier Price</td></tr>
                <%
                ...
                <%
                    ...
                    session.setAttribute("staffSearchItems", null);
                %>
            </table>
        </div>
